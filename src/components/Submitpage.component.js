      ...
      <div className="allsubmit">
        <div className="busyness">
              ...
              <DropdownMenu>
                ...
                {this.state.isHovering1 && (
                  <div className="hover1">
                    <u>
                      <i>(No lineup to get in, short checkout lines)</i>
                    </u>
                  </div>
                )}
                <DropdownItem>
                ...
                {this.state.isHovering2 && (
                  <div className="hover1">
                    <u>
                      <i>(No lineup to get in, moderate checkout lines)</i>
                    </u>
                  </div>
                )}
                <DropdownItem>
                ...
                {this.state.isHovering3 && (
                  <div className="hover1">
                    <u>
                      <i>(No lineup to get in, long checkout lines)</i>
                    </u>
                  </div>
                )}
                <DropdownItem>
                ...
                {this.state.isHovering4 && (
                  <div className="hover1">
                    <u>
                      <i>(Short lineup to get in, less than 10 min)</i>
                    </u>
                  </div>
                )}
                <DropdownItem>
                ...
                {this.state.isHovering5 && (
                  <div className="hover1">
                    <u>
                      <i>(Long lineup to get in, less than 30 min)</i>
                    </u>
                  </div>
                )}
                <DropdownItem>
                ...
                {this.state.isHovering6 && (
                  <div className="hover1">
                    <u>
                      <i>(Very long lineup to get in, more than 30 min)</i>
                    </u>
                  </div>
                )}
              </DropdownMenu>
          ...
          <div className="button2">
            <button className="actualButton2" onClick={(e) => this.onSubmit(e)}>
              {" "}
              Submit!{" "}
            </button>
